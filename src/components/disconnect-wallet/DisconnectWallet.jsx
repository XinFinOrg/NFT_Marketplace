...
import { Disconnect  } from "xdc-connect";

const DisConnectWalletComponent = () => {

	const handleDisconnectClicked = async () => {
		Disconnect();		
		app.nft.setLastTokenLoaded(0);
		app.xdc3.handleDisconnect();
	}

return (
    <li className="nav-item">

    <Link className={`nav-link`} to="#" onClick={()=>handleDisconnectClicked()}>
...
export default DisConnectWalletComponent;